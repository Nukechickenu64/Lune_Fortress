...
/datum/preferences
	...
	proc/ShowChoices(mob/user)
		...
		if(femstatic_rank.Find(ckey(user.client.key)))
			dat += "<b>Gender:</b> <a href='?_src_=prefs;preference=gender'><b>Female</b></a><br>"
		else
		...
		if(user?.client?.work_chosen == "Jester")
			dat += "<br><b>Archetype:</b> <a href='?_src_=prefs;preference=lobbybe'><b>[lobbyspecie == "Adult" ? "Court" : "Court"]</b></a>" // Disabling Midget Jester until I know whats wrong can be renabled by replacing a Court with Classic
...
//			dat += "<br><b>Archetype:</b> <a href='?_src_=prefs;preference=inqui'><b>[InquisiPref]</b></a>"
		...
		if(user?.client?.work_chosen == "Court Bodyguard")
			dat += "<br><b>Archetype:</b> <a href='?_src_=prefs;preference=bodyguard'><b>[BodyguardPref]</b></a>"
