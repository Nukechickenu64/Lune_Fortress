...
*/
	...
	proc/LateChoices()
		...
		var/list/allowedFatesList = list("Migrant","Bum","Servant","Nun","Maid","Urchin","Tribunal Veteran","Madam","Soiler","Misero","Merchant","Docker","Vicar","Sniffer","Amuser","Pusher","Apprentice","Butler","Sitzfrau","Sniffer","Consyte","Scuff","Mortus","Guest","Fortune Teller", "Boozehound", "Ganger", "Warrior","Rogue","Wizard","Bard","Barbarian","Druid","Monk","Paladin","Warlock","Artificer","Cleric","Prisoner","Sojourner")
