...
/mob/living/carbon/human/proc/updateSpider()
	...
	switch(job)
		if("Vicar")
			text += "<a href='#'' id='Excommunicate'>Excommunicate<br></a><a href='#'' id='BanishtheUndead'>Banish Undead</a><a href='#'' id='RobofSins'><br>Rob of Sins<br></a><a href='#' id='Epitemia''>Epitemia<br></a><a href='#'' id='RewardtheInquisitor'>Reward the Inquisitor</a><a href='#'' id='Coronation'><br>Coronation</a><a href='#'' id='Eucharisty'><br>Eucharisty<br></a><a href='#'' id='BannishSpirits'>Banish Spirits<br></a><a href='#'' id='CallforChurchMeeting'>Call for Chuch Meeting<br></a><a href='#' id='Marriage''>Marriage!<br></a><a href='#' id='ClearName''>Clear Name<br></a>"
		if("Priest")
			text += "<a href='#'' id='Excommunicate'>Excommunicate<br></a><a href='#'' id='BanishtheUndead'>Banish Undead</a><a href='#'' id='RobofSins'><br>Rob of Sins<br></a><a href='#' id='Epitemia''>Epitemia<br></a><a href='#'' id='RewardtheInquisitor'>Reward the Inquisitor</a><a href='#'' id='Coronation'><br>Coronation</a><a href='#'' id='Eucharisty'><br>Eucharisty<br></a><a href='#'' id='BannishSpirits'>Banish Spirits<br></a><a href='#'' id='CallforChurchMeeting'>Call for Chuch Meeting<br></a><a href='#' id='Marriage''>Marriage!<br></a><a href='#' id='ClearName''>Clear Name<br></a>"
		if("Monk")
			text += "<a href='#'' id='BanishtheUndead'>Banish Undead</a><a href='#'' id='RobofSins'><br>Rob of Sins<br></a><a href='#'' id='Eucharisty'><br>Eucharisty<br></a><a href='#'' id='BannishSpirits'>Banish Spirits<br></a><a href='#' id='Marriage!''>Marriage<br></a>"
...
/mob/proc/updatePig()
	...
	if(ishuman(src))
		...
		if(H.anchored && istype(H.anchored, /obj/structure/stool/bed/chair/comfy/judge) && H.job == "Magistrate")
			buttonTimes++
...
/mob/proc/updateButtons()
	...
	client.changebuttoncontent("#They", {"<span class='segment1'>[generateVerbList(list(list("ExtendTentacles", "Extend Tentacles"), list("Assimilate", "Assimilate"), list("Hunt", "Hunt"), list("infest", "Infest the Lifeweb"), list("Lump", "Lump"), list("Learnch", "Learn from the Associates"), list("RegenerativeStasis", "Regenerative Stasis")))]</span>"})
...
/mob/proc/spiderUpdate()
	...
	if(ishuman(src))
		...
		if(H.job == "Vicar" || H.old_job == "Vicar")
			verbs += list(list("Excommunicate", "Excommunicate"), list("BanishtheUndead", "Banish Undead"), list("RobofSins", "Rob of Sins"), list("Epitemia", "Epitemia"), list("RewardtheInquisitor", "Reward the Inquisitor"), list("Coronation", "Coronation"), list("Eucharisty", "Eucharisty"), list("BannishSpirits", "Banish Spirits"), list("CallforChurchMeeting", "Call for Church Meeting"), list("Marriage", "Marriage!"), list("ClearName", "Clear Name"), list("BloodyHands", "Bloody Hands"))
		if(H.job == "Magistrate" || H.old_job == "Magistrate")
			verbs += list(list("Execution", "Order Execution"), list("Duel" ,"Order a Duel"), list("GreatHunt", "Sign a Hunt Warrant", list("ClearNameM", "Clear Name", list("Fine", "Fine"))))
		if(H.job == "Priest" || H.old_job == "Priest")
			verbs += list(list("Excommunicate", "Excommunicate"), list("BanishtheUndead", "Banish Undead"), list("RobofSins", "Rob of Sins"), list("Epitemia", "Epitemia"), list("RewardtheInquisitor", "Reward the Inquisitor"), list("Coronation", "Coronation"), list("Eucharisty", "Eucharisty"), list("BannishSpirits", "Banish Spirits"), list("CallforChurchMeeting", "Call for Church Meeting"), list("Marriage", "Marriage!"), list("ClearName", "Clear Name", list("BloodyHands", "Bloody Hands")))
		if(H.job == "Monk" || H.old_job == "Monk")
			verbs += list(list("BanishtheUndead", "Banish Undead"), list("RobofSins", "Rob of Sins"), list("Eucharisty", "Eucharisty"), list("BannishSpirits", "Banish Spirits"), list("Marriage", "Marriage"))
...
/mob/proc/defaultButton()
	...
	if(istype(src, /mob/new_player) && ticker.current_state == GAME_STATE_PREGAME)
		...
		client.changebuttoncontent("#chrome", "<span class='segment1'>" + generateVerbList(list(list("LimparCromossomos", "(100) Wipe Chromosomes"), list("ChamarCharon", "(10) Launch Ulysses"), list("ForcePadla", "(7) Force Padla"), list("ReceiveObols", "(1) Receive Obols"), list("RetirarVice", "(1) Remove Vice"))) + "</span>")
	else
		client.changebuttoncontent("#chrome", "<span class='segment1'>" + generateVerbList(list(list("LimparCromossomos", "(100) Wipe Chromosomes"), list("ChamarCharon", "(10) Launch Ulysses"), list("ForcePadla", "(7) Force Padla"), list("ReRolarSpecial", "(2) Reroll Special"))) + "</span>")
