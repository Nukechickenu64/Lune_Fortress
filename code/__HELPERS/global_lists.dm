...
var/list/puppeteers = list() //actual people responsible for handling donoses, bans and ranks/deranks.
...
var/global/list/landmarks_list = list()
var/global/list/ttracks_list = list()				//list of all train tracks created
