...
/mob/living/carbon/human/proc/updateSmalltext()
	...
	if(job == "Sniffer")
		...
		text += "Investigation Points: <span id='timepusher'>[Inquisitor_Points]</span>"
	if(old_ways.god)
		if(old_ways.god == "Xom")
...
/mob/dead/observer/noteUpdate()
	...
	note += "Pain: [client.wraith_pain]<BR>"
